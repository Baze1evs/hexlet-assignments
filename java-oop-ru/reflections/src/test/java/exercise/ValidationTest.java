...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Address address3 = new Address("Russia", "Ufa", "Lenina", "54", null);
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("city", List.of("length less than 4"));
        assertThat(result3).isEqualTo(expected3);

        User user = new User(1L, "Vasya", "28");
        Map<String, List<String>> result4 = Validator.advancedValidate(user);
        Map<String, List<String>> expected4 = Map.of("id", List.of("field doesn't have length attribute"));
